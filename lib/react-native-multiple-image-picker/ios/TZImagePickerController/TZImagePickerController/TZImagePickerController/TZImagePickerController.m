...
//    self.oKButtonTitleColorDisabled = [UIColor colorWithRed:(83/255.0) green:(179/255.0) blue:(17/255.0) alpha:0.5];
    self.oKButtonTitleColorNormal   = [UIColor colorWithRed:0.06 green:0.31 blue:0.96 alpha:1.0];
    self.oKButtonTitleColorDisabled = [UIColor colorWithRed:0.06 green:0.31 blue:0.96 alpha:0.5];
//    
    if (iOS7Later) {
